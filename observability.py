...
class MetricsExporter:
    ...
    def export_prometheus(self, status: Dict, labels: Optional[Dict[str, str]] = None) -> str:
        """
    ...
    def export_cloudwatch(self, status: Dict, namespace: str = "Starlink/Connection") -> Dict:
        """
...
class PeriodicReporter:
    ...
    def generate_report(self, sla_thresholds: Optional[Dict] = None) -> Dict:
        ...
        uptime_percentage = (stable_measurements / total_measurements * 100) if total_measurements > 0 else 0
        ...
        if sla_thresholds:
            report["sla_compliance"] = self._check_sla_compliance(sla_thresholds, report["summary"])
