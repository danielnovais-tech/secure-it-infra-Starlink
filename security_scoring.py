...
class SecurityScorer:
    ...
    def _load_multipliers_from_config(self, config_file: str) -> Dict[SecurityLevel, float]:
        ...
        try:
            ...
            logger.warning(f"Failed to read config from {config_file}: {e}. Using defaults.")
    ...
    def get_audit_trail(self, detail_level: Literal["summary", "full"] = "full") -> List[Dict]:
        """
    ...
    def export_audit_trail_json(self, filepath: str, detail_level: Literal["summary", "full"] = "full") -> None:
        """
    ...
    def export_audit_trail_csv(self, filepath: str) -> None:
        ...
        fieldnames = [
            'timestamp', 'reason', 'points', 'security_level',
            'original_score', 'adjusted_score', 'previous_score', 'historical_delta'
        ]
